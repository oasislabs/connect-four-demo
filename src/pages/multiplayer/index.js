...
import GameLogo from '../../assets/2x/logo_connect_hd.png'
...
class Multiplayer extends React.Component {
  ...
  async createGame (gameId, web3c, eventsWeb3c, newPrivateKey) {
    ...
    // 7000000 gas cost set empirically (minimizes estimates for latency).
    return new Game(server, gameId, 7000000)
  }
